module ApplicationHelper
    ...
    def link_to_add_fields(name, f, association)
        ...
        # Takes an object (@category) and creates a new instance of its associated model (:products)
        ...
        # fields_options = { child_index: id }
            ...
            # `category[products_attributes][child_index_value][_destroy]`
        fields = f.fields_for(association, new_object, child_index: id) do |builder|
            ...
            render("/admin/products/product_fields", f: builder)
        end
